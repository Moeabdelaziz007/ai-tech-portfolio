...
import { ArrowLeft, Download, Upload, BookOpen, Cube, Settings } from 'lucide-react';
...
import { ADVANCED_GATE_TOOLTIPS, ADVANCED_EXAMPLES } from '../lib/advancedGates';
...
export const QuantumSimulatorPage: React.FC = () => {
  ...
  const [simulationType, setSimulationType] = useState<'exact' | 'sampling'>('sampling');
  ...
  const runSimulation = async () => {
    ...
    try {
      ...
      setSimulationError('Error running simulation. Please check your circuit configuration.');
    } finally {
    ...
    switch (example) {
      case 'bell':
        ...
        setGates([
          ...
          { id: 'bell-cnot-1', type: 'CNOT', position: 1, targetQubit: 1, controlQubit: 0 }
        ]);
        break;
      case 'ghz':
        setQubits(3);
        setGates([
          ...
          { id: 'ghz-cnot-1', type: 'CNOT', position: 1, targetQubit: 1, controlQubit: 0 },
          { id: 'ghz-cnot-2', type: 'CNOT', position: 2, targetQubit: 2, controlQubit: 0 }
        ]);
        break;
      case 'superposition':
        setQubits(1);
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Advanced quantum computing simulator with 3D visualization, tutorials, and circuit management.
          </p>
        </div>
        ...
        {/* Example Circuits */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-3">Example Circuits</h3>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden">
              <div className="bg-blue-500 text-white p-4">
                <h3 className="text-xl font-bold">Circuit Manager</h3>
              </div>
              
              <div className="p-6 overflow-y-auto max-h-[60vh]">
                <div className="mb-4">
                  <h4 className="font-semibold mb-2">Save Current Circuit</h4>
                  <button
                    onClick={saveCircuit}
                    className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm transition-colors"
                  >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    <label className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm transition-colors cursor-pointer">
                ...
                <div>
                  <h4 className="font-semibold mb-2">Saved Circuits</h4>
                  {savedCircuits.length === 0 ? (
                    <p className="text-gray-500">No saved circuits</p>
                  ) : (
        ...
        {/* Error Display */}
        <ErrorDisplay errors={errors} onClear={clearErrors} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6 simulation-controls">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Simulation Controls</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSimulationType(e.target.value as 'exact' | 'sampling')}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="sampling">Sampling (Multiple Measurements)</option>
                    <option value="exact">Exact (State Vector)</option>
                  </select>
                </div>
                ...
                {simulationType === 'sampling' && (
                  <div>
                    ...
                    <input
                      type="number"
                      value={shots}
                      onChange={(e) => setShots(Math.max(100, parseInt(e.target.value) || 1000))}
                      min="100"
                      max="10000"
                      className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                ...
                <button
                  ...
                  disabled={isSimulating || errors.some(e => e.type === 'error')}
            ...
            {results && (
              <ResultChart 
                counts={results} 
                title={simulationType === 'exact' ? 'Exact Probabilities' : 'Measurement Results'}
              />
            )}
          </div>
        </div>
